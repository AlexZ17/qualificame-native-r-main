			...
			<View style={styles.container}>
				...
				<View style={[styles.flex1]}>
					...
					<ScrollView contentContainerStyle={styles.baseHorizontalMargin}>
						<View>
							<BodyText
								text='Estos son los eventos de este dia, si necesitas más información puedes crear un reporte.'
								color='dark'
							/>
						</View>
							...
							<View style={[styles.alignItemsCenter]}>
								<View style={[styles.row, styles.baseTopMargin]}>
									<Pill
										...
										onPress={() => this.props.navigation.navigate('ReactionDetailScreen', {
											kiosk: this.state.kiosk,
											total: String(total_excellent),
											reaction: 'excelent'
										})}
										disabled={!total_excellent}
									/>
									...
									<Pill
										...
										onPress={() => this.props.navigation.navigate('ReactionDetailScreen', {
											kiosk: this.state.kiosk,
											total: String(total_average),
											reaction: 'good'
										})}
										disabled={!total_average}
									/>
								</View>
								<View style={[styles.row, styles.smallTopMargin]}>
									...
									<Pill
										...
										onPress={() => this.props.navigation.navigate('ReactionDetailScreen', {
											kiosk: this.state.kiosk,
											total: String(total_awful),
											reaction: 'horrible'
										})}
										disabled={!total_awful}
									/>
								</View>
							</View>
						</View>
