...
export default class CreateAccountScreen extends Component {
	...
	handleCreateAccount = () => {
		...
		if (this.state.password != this.state.password1) {
			return this.setState({
				showAlert: true,
				alertHead: 'Verifica tu contraseña',
				alertBody: 'Asegúrate de que las contraseñas coincidan'
			})
		}
				...
				<View style={styles.container}>
					...
					>
						<ScrollView>
							...
							/>
							<SubtitleText
								text={'Eres dueño de ' + this.props.navigation.state.params.companyName + ', cuentanos más sobre ti'}
								color="green"
								weight="light"
							/>
